...
import successAnimation from "../assets/meluncur.json";
...
const Courier = () => {
    ...
    const [selectedSenderCountry, setSelectedSenderCountry] = useState(countryOptions[0].code);
    const [selectedReceiverCountry, setSelectedReceiverCountry] = useState(countryOptions[0].code);
    ...
    return (
        <Box flex={1} bg="coolGray.100">
            <Header title="Pengiriman Barang" withBack={true} />
            {/* Form Input */}
            ...
            <Modal isOpen={isDetailOrderModalOpen} onClose={() => setIsDetailOrderModalOpen(false)}>
                <Modal.Content maxWidth="90%" borderRadius="lg">
                    <Modal.CloseButton />
                    <Modal.Header>
                        <Text fontSize="lg" fontWeight="bold" textAlign="center">Detail Order</Text>
                    </Modal.Header>
                    <Modal.Body>
                        <VStack space={5}>
                            {/* Nomor Ponsel Pengirim */}
                            <VStack space={2}>
                                <Text fontSize="md" fontWeight="bold">Nomor Ponsel Pengirim</Text>
                                <HStack space={3} alignItems="center">
                                    <Select
                                        selectedValue={selectedSenderCountry}
                                        onValueChange={setSelectedSenderCountry}
                                        minWidth="28%"
                                        borderWidth={1}
                                        borderColor="coolGray.300"
                                        borderRadius="md"
                                        accessibilityLabel="Pilih Kode Negara"
                                    >
                                ...
                                {senderPhone === "" && (
                                    <Text fontSize="xs" color="red.500">Masukkan nomor ponsel</Text>
                                )}
                            </VStack>

                            {/* Nomor Ponsel Penerima */}
                            <VStack space={2}>
                                <Text fontSize="md" fontWeight="bold">Nomor Ponsel Penerima</Text>
                                <HStack space={3} alignItems="center">
                                    <Select
                                        selectedValue={selectedReceiverCountry}
                                        onValueChange={setSelectedReceiverCountry}
                                        minWidth="28%"
                                        borderWidth={1}
                                        borderColor="coolGray.300"
                                        borderRadius="md"
                            ...
                            {/* Deskripsi Barang */}
                            <VStack space={2}>
                                <Text fontSize="md" fontWeight="bold">Apa yang Diantarkan</Text>
                                <Input
                                    placeholder="Contoh: kotak berukuran sedang dengan barang mudah pecah yang berbobot 5 kg"
                    ...
                    <Modal.Footer>
                        <Button
                            ...
                            onPress={() => {
                                ...
                                if (senderPhone && receiverPhone && itemDescription) {
                                    toast.show({
